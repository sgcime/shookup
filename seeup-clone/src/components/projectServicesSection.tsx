...
export default function ServicesSection() {
  ...
  const icons = [
    <svg key="tax" viewBox="0 0 80 80" fill="none" stroke="#0fb4b6" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="w-20 h-20">
      <path d="M40 12L15 24L40 36L65 24L40 12Z" />
      <path d="M15 34L40 46L65 34" />
      <path d="M15 44L40 56L65 44" />
      <path d="M15 54L40 66L65 54" />
    </svg>,
    <svg key="profit" viewBox="0 0 80 80" fill="none" stroke="#0fb4b6" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="w-20 h-20">
    ...
    <svg key="revenue" viewBox="0 0 80 80" fill="none" stroke="#0fb4b6" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="w-20 h-20">
    ...
    <svg key="display" viewBox="0 0 80 80" fill="none" stroke="#0fb4b6" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="w-20 h-20">
    ...
    <svg key="automation" viewBox="0 0 80 80" fill="none" stroke="#0fb4b6" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="w-20 h-20">
    ...
    <svg key="promotion" viewBox="0 0 80 80" fill="none" stroke="#0fb4b6" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="w-20 h-20">
